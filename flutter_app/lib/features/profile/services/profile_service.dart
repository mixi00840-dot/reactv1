...
class ProfileService {
  ...
  Future<List<dynamic>> getUserContent(String userId,
  ...
  Future<void> updatePrivacySettings({
    ...
    if (allowMessages != null)
      body['privacySettings']['allowMessages'] = allowMessages;
    if (allowComments != null)
      body['privacySettings']['allowComments'] = allowComments;
    if (showOnlineStatus != null)
      body['privacySettings']['showOnlineStatus'] = showOnlineStatus;
