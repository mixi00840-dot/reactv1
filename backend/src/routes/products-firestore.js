...
const router = express.Router(); * Products Routes - Firestore Version

const productController = require('../controllers/productController'); * Migrated from MongoDB to Firestore

const { authMiddleware, sellerMiddleware, optionalAuthMiddleware } = require('../middleware/auth'); */



// Public routesconst express = require('express');

router.get('/', optionalAuthMiddleware, productController.getProducts);const router = express.Router();

router.get('/:id', optionalAuthMiddleware, productController.getProduct);const { authenticateUser, authorizeRoles } = require('../middleware/auth');

const {

// Protected routes (seller/admin)  createProduct,

router.post('/', authMiddleware, sellerMiddleware, productController.createProduct);  getProductById,

router.put('/:id', authMiddleware, productController.updateProduct);  updateProduct,

router.delete('/:id', authMiddleware, productController.deleteProduct);  deleteProduct,

  listProducts,

// Reviews  searchProducts,

router.post('/:id/reviews', authMiddleware, productController.addReview);  getProductsByStore,

  incrementViews,

// Stats  incrementLikes,

router.get('/:id/stats', authMiddleware, productController.getProductStats);  decrementLikes,

  getSimilarProducts,

module.exports = router;  updateInventory
