...
const router = express.Router(); * Stores Routes (Firestore Implementation)

const storeController = require('../controllers/storeController'); * Handles store management, discovery, and interactions
...
router.get('/', optionalAuthMiddleware, storeController.getStores);const router = express.Router();

router.get('/:id', optionalAuthMiddleware, storeController.getStore);const { authenticateUser, authorizeRoles } = require('../middleware/auth');

const {

// Protected routes  createStore,

router.post('/', authMiddleware, storeController.createStore);  getStoreById,

router.put('/:id', authMiddleware, storeController.updateStore);  getStoreBySlug,

router.delete('/:id', authMiddleware, storeController.deleteStore);  updateStore,

  deleteStore,

module.exports = router;  listStores,
