...
const router = express.Router(); * Orders Route (Firestore)

const orderController = require('../controllers/orderController'); * 

const { authMiddleware } = require('../middleware/auth'); * Handles e-commerce order processing with atomic transactions

 */

// All order routes require authentication

router.use(authMiddleware);const express = require('express');

const router = express.Router();

// Routesconst {

router.get('/', orderController.getOrders);  ORDER_STATUS,

router.get('/:id', orderController.getOrder);  PAYMENT_STATUS,

router.post('/', orderController.createOrder);  createOrder,

router.patch('/:id/status', orderController.updateOrderStatus);  getOrderById,

router.delete('/:id', orderController.cancelOrder);  getOrders,

  updateOrderStatus,

module.exports = router;  updateShipping,
