...
class LikedContentScreen extends ConsumerWidget {
  const LikedContentScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final likedContentAsync = ref.watch(likedContentProvider);
      ...
      body: likedContentAsync.when(
        data: (content) {
          ...
          return RefreshIndicator(
            onRefresh: () async {
              ref.invalidate(likedContentProvider);
            },
        ...
        error: (error, stack) => Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              ElevatedButton(
                onPressed: () => ref.refresh(likedContentProvider),
